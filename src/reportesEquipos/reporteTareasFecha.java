 ...
 * @author Exe
 */
public class reporteTareasFecha extends Conexion{
    
    private String reporte;
    private String filtroFechaDesde, filtroFechaHasta;
    
    public reporteTareasFecha(String reporte, String filtroFechaDesde, String filtroFechaHasta) {//constructor
    ...
    public void generarReporte(){
        ...
        try{
            ...
            String path = "src\\reportesEquipos\\reporteTareasFecha.jasper";
